...
# -*- coding: utf-8 -*-
#
# spliced documentation build configuration file, created by
...
from spliced.utils import add_spack_to_path
...
latex_documents = [
    ("index", "spliced.tex", "Spliced Documentation", "Vanessa Sochat", "manual"),
]
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat"],
        "spliced",
        "Spliced makes predictions for package splicing",
        "Miscellaneous",
    ),
]
